...
def print_graph_info():
    ...
    print("\n--- DFS ---")
    dfs_order = graph.dfs(graph.vertices[0])  # Assuming start_vertex is the first in list
    print(f"Order of nodes visited in DFS: {dfs_order}")
    graph.dfs_draw_tree(graph.vertices[0])
